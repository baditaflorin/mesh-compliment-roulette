# mesh-compliment-roulette

[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-compliment-roulette-ff7eb6)](https://baditaflorin.github.io/mesh-compliment-roulette/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-compliment-roulette/blob/main/package.json)
...
**Source → https://github.com/baditaflorin/mesh-compliment-roulette**
...
git clone https://github.com/baditaflorin/mesh-compliment-roulette
cd mesh-compliment-roulette
npm install
npm run dev
```
...
- `mesh-compliment-roulette:signalingUrl`
- `mesh-compliment-roulette:turnTokenUrl`
- `mesh-compliment-roulette:iceServers`
- `mesh-compliment-roulette:room`
